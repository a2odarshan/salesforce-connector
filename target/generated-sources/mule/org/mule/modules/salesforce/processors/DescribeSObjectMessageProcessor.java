    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final String _transformedType = ((String) evaluateAndTransform(getMuleContext(), event, DescribeSObjectMessageProcessor.class.getDeclaredField("_typeType").getGenericType(), null, type));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((BaseSalesforceConnector) object).describeSObject(_transformedType);
                }
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("describeSObject"), event, e);
        }
    }
