    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final String _transformedType = ((String) evaluateAndTransform(getMuleContext(), event, GetUpdatedRangeMessageProcessor.class.getDeclaredField("_typeType").getGenericType(), null, type));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((BaseSalesforceConnector) object).getUpdatedRange(_transformedType, _transformedStartTime, _transformedEndTime);
                }
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("getUpdatedRange"), event, e);
        }
    }
