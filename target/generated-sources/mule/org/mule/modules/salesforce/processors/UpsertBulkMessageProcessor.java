    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final String _transformedType = ((String) evaluateAndTransform(getMuleContext(), event, UpsertBulkMessageProcessor.class.getDeclaredField("_typeType").getGenericType(), null, type));
            final String _transformedExternalIdFieldName = ((String) evaluateAndTransform(getMuleContext(), event, UpsertBulkMessageProcessor.class.getDeclaredField("_externalIdFieldNameType").getGenericType(), null, externalIdFieldName));
            final List<Map<String, Object>> _transformedObjects = ((List<Map<String, Object>> ) evaluateAndTransform(getMuleContext(), event, UpsertBulkMessageProcessor.class.getDeclaredField("_objectsType").getGenericType(), null, objects));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((BaseSalesforceConnector) object).upsertBulk(_transformedType, _transformedExternalIdFieldName, _transformedObjects);
                }
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("upsertBulk"), event, e);
        }
    }
