...
/**
 * UpsertMessageProcessor invokes the {@link org.mule.modules.salesforce.BaseSalesforceConnector#upsert(java.lang.String, java.lang.String, java.util.List)} method in {@link BaseSalesforceConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final String _transformedExternalIdFieldName = ((String) evaluateAndTransform(getMuleContext(), event, UpsertMessageProcessor.class.getDeclaredField("_externalIdFieldNameType").getGenericType(), null, externalIdFieldName));
            ...
            final List<Map<String, Object>> _transformedObjects = ((List<Map<String, Object>> ) evaluateAndTransform(getMuleContext(), event, UpsertMessageProcessor.class.getDeclaredField("_objectsType").getGenericType(), null, objects));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((BaseSalesforceConnector) object).upsert(_transformedExternalIdFieldName, _transformedType, _transformedObjects);
                }
