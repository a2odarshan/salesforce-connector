    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final String _transformedType = ((String) evaluateAndTransform(getMuleContext(), event, HardDeleteBulkMessageProcessor.class.getDeclaredField("_typeType").getGenericType(), null, type));
            final List<Map<String, Object>> _transformedObjects = ((List<Map<String, Object>> ) evaluateAndTransform(getMuleContext(), event, HardDeleteBulkMessageProcessor.class.getDeclaredField("_objectsType").getGenericType(), null, objects));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((BaseSalesforceConnector) object).hardDeleteBulk(_transformedType, _transformedObjects);
                }
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("hardDeleteBulk"), event, e);
        }
    }
