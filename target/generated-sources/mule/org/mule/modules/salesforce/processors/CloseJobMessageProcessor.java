    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final String _transformedJobId = ((String) evaluateAndTransform(getMuleContext(), event, CloseJobMessageProcessor.class.getDeclaredField("_jobIdType").getGenericType(), null, jobId));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((BaseSalesforceConnector) object).closeJob(_transformedJobId);
                }
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("closeJob"), event, e);
        }
    }
